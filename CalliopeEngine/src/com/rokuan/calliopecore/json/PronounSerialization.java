...
public class PronounSerialization {
    ...
    public static class Serializer implements JsonSerializer<IPronoun> {
        @Override
        public JsonElement serialize(IPronoun arg0, Type arg1, JsonSerializationContext arg2) {
    ...
    public static class Deserializer implements JsonDeserializer<IPronoun> {
        @Override
        public IPronoun deserialize(JsonElement arg0, Type arg1, JsonDeserializationContext arg2) throws JsonParseException {
