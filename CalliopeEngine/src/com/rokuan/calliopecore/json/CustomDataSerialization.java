...
public class CustomDataSerialization {
    ...
    private static class CustomData {
        private static class Serializer implements JsonSerializer<ICustomData> {
            @Override
            public JsonElement serialize(ICustomData arg0, Type arg1, JsonSerializationContext arg2) {
        ...
        private static class Deserializer implements JsonDeserializer<ICustomData> {
            @Override
            public ICustomData deserialize(JsonElement arg0, Type arg1, JsonDeserializationContext arg2) throws JsonParseException {
    ...
    public static class CustomObject {
        public static class Serializer implements JsonSerializer<ICustomObject> {
            @Override
            public JsonElement serialize(ICustomObject arg0, Type arg1, JsonSerializationContext arg2) {
        ...
        public static class Deserializer implements JsonDeserializer<ICustomObject> {
            @Override
            public ICustomObject deserialize(JsonElement arg0, Type arg1, JsonDeserializationContext arg2) throws JsonParseException {
    ...
    public static class CustomPlace {
        public static class Serializer implements JsonSerializer<ICustomPlace> {
            @Override
            public JsonElement serialize(ICustomPlace arg0, Type arg1, JsonSerializationContext arg2) {
                return new GsonBuilder().registerTypeAdapter(ICustomData.class, new CustomData.Serializer())
                        .create()
                        .toJsonTree(arg0, ICustomData.class);
            }
        ...
        public static class Deserializer implements JsonDeserializer<ICustomPlace> {
            @Override
            public ICustomPlace deserialize(JsonElement arg0, Type arg1, JsonDeserializationContext arg2) throws JsonParseException {
                final ICustomData data = new GsonBuilder().registerTypeAdapter(ICustomData.class, new CustomData.Deserializer())
                        .create()
                        .fromJson(arg0, ICustomData.class);
    ...
    public static class CustomPerson {
        public static class Serializer implements JsonSerializer<ICustomPerson> {
            @Override
            public JsonElement serialize(ICustomPerson arg0, Type arg1, JsonSerializationContext arg2) {
                return new GsonBuilder().registerTypeAdapter(ICustomData.class, new CustomData.Serializer())
                        .create()
                        .toJsonTree(arg0, ICustomData.class);
            }
        ...
        public static class Deserializer implements JsonDeserializer<ICustomPerson> {
            @Override
            public ICustomPerson deserialize(JsonElement arg0, Type arg1, JsonDeserializationContext arg2) throws JsonParseException {
                final ICustomData data = new GsonBuilder().registerTypeAdapter(ICustomData.class, new CustomData.Deserializer())
                        .create()
                        .fromJson(arg0, ICustomData.class);
    ...
    public static class CustomMode {
        public static class Serializer implements JsonSerializer<ICustomMode> {
            @Override
            public JsonElement serialize(ICustomMode arg0, Type arg1, JsonSerializationContext arg2) {
                return new GsonBuilder().registerTypeAdapter(ICustomData.class, new CustomData.Serializer())
                        .create()
                        .toJsonTree(arg0, ICustomData.class);
            }
        ...
        public static class Deserializer implements JsonDeserializer<ICustomMode> {
            @Override
            public ICustomMode deserialize(JsonElement arg0, Type arg1, JsonDeserializationContext arg2) throws JsonParseException {
                final ICustomData data = new GsonBuilder().registerTypeAdapter(ICustomData.class, new CustomData.Deserializer())
                        .create()
                        .fromJson(arg0, ICustomData.class);
