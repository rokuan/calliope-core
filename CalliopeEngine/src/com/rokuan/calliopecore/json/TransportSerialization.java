...
public class TransportSerialization {
    ...
    public static class Serializer implements JsonSerializer<ITransportInfo> {
        @Override
        public JsonElement serialize(ITransportInfo arg0, Type arg1, JsonSerializationContext arg2) {
    ...
    public static class Deserializer implements JsonDeserializer<ITransportInfo> {
        @Override
        public ITransportInfo deserialize(JsonElement arg0, Type arg1, JsonDeserializationContext arg2) throws JsonParseException {
