...
public class CitySerialization {
    ...
    public static class Serializer implements JsonSerializer<ICityInfo> {
        @Override
        public JsonElement serialize(ICityInfo arg0, Type arg1, JsonSerializationContext arg2) {
    ...
    public static class Deserializer implements JsonDeserializer<ICityInfo> {
        @Override
        public ICityInfo deserialize(JsonElement arg0, Type arg1, JsonDeserializationContext arg2) throws JsonParseException {
