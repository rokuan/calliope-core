...
public class NameSerialization {
    ...
    public static class Serializer implements JsonSerializer<INameInfo> {
        @Override
        public JsonElement serialize(INameInfo arg0, Type arg1, JsonSerializationContext arg2) {
    ...
    public static class Deserializer implements JsonDeserializer<INameInfo> {
        @Override
        public INameInfo deserialize(JsonElement arg0, Type arg1, JsonDeserializationContext arg2) throws JsonParseException {
