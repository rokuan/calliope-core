...
public class CountrySerialization {
    ...
    public static class Serializer implements JsonSerializer<ICountryInfo> {
        @Override
        public JsonElement serialize(ICountryInfo arg0, Type arg1, JsonSerializationContext arg2) {
    ...
    public static class Deserializer implements JsonDeserializer<ICountryInfo> {
        @Override
        public ICountryInfo deserialize(JsonElement arg0, Type arg1, JsonDeserializationContext arg2) throws JsonParseException {
