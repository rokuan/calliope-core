...
public class ActionSerialization {
    ...
    public static class Serializer implements JsonSerializer<IAction> {
        @Override
        public JsonElement serialize(IAction arg0, Type arg1, JsonSerializationContext arg2) {
    ...
    public static class Deserializer implements JsonDeserializer<IAction> {
        @Override
        public IAction deserialize(JsonElement arg0, Type arg1, JsonDeserializationContext arg2) throws JsonParseException {
