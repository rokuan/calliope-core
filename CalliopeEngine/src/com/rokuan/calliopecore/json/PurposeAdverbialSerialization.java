...
public class PurposeAdverbialSerialization {
    ...
    public static class Serializer implements JsonSerializer<IPurposeObject> {
        @Override
        public JsonElement serialize(IPurposeObject arg0, Type arg1, JsonSerializationContext arg2) {
            JsonElement result;
    ...
    public static class Deserializer implements JsonDeserializer<IPurposeObject> {
        @Override
        public IPurposeObject deserialize(JsonElement arg0, Type arg1, JsonDeserializationContext arg2) throws JsonParseException {
