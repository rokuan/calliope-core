...
public class PrepositionSerialization {
    ...
    public static class PlacePreposition {
        public static class Serializer implements JsonSerializer<IPlacePreposition> {
            @Override
            public JsonElement serialize(IPlacePreposition arg0, Type arg1, JsonSerializationContext arg2) {
        ...
        public static class Deserializer implements JsonDeserializer<IPlacePreposition> {
            @Override
            public IPlacePreposition deserialize(JsonElement arg0, Type arg1, JsonDeserializationContext arg2) throws JsonParseException {
    ...
    public static class TimePreposition {
        public static class Serializer implements JsonSerializer<ITimePreposition> {
            @Override
            public JsonElement serialize(ITimePreposition arg0, Type arg1, JsonSerializationContext arg2) {
                JsonObject obj = new JsonObject();
                obj.add(JSON_PREP_VALUE_KEY, new JsonPrimitive(arg0.getValue()));
                obj.add(JSON_PREP_CONTEXT_KEY, new JsonPrimitive(arg0.getContext().name()));
                return obj;
        ...
        public static class Deserializer implements JsonDeserializer<ITimePreposition> {
            @Override
            public ITimePreposition deserialize(JsonElement arg0, Type arg1, JsonDeserializationContext arg2) throws JsonParseException {
                JsonObject obj = arg0.getAsJsonObject();
    ...
    public static class WayPreposition {
        public static class Serializer implements JsonSerializer<IWayPreposition> {
            @Override
            public JsonElement serialize(IWayPreposition arg0, Type arg1, JsonSerializationContext arg2) {
                JsonObject obj = new JsonObject();
                obj.add(JSON_PREP_VALUE_KEY, new JsonPrimitive(arg0.getValue()));
                obj.add(JSON_PREP_CONTEXT_KEY, new JsonPrimitive(arg0.getContext().name()));
                return obj;
        ...
        public static class Deserializer implements JsonDeserializer<IWayPreposition> {
            @Override
            public IWayPreposition deserialize(JsonElement arg0, Type arg1, JsonDeserializationContext arg2) throws JsonParseException {
                JsonObject obj = arg0.getAsJsonObject();
    ...
    public static class PurposePreposition {
        public static class Serializer implements JsonSerializer<IPurposePreposition> {
            @Override
            public JsonElement serialize(IPurposePreposition arg0, Type arg1, JsonSerializationContext arg2) {
                JsonObject obj = new JsonObject();
                obj.add(JSON_PREP_VALUE_KEY, new JsonPrimitive(arg0.getValue()));
                obj.add(JSON_PREP_CONTEXT_KEY, new JsonPrimitive(arg0.getContext().name()));
                return obj;
        ...
        public static class Deserializer implements JsonDeserializer<IPurposePreposition> {
            @Override
            public IPurposePreposition deserialize(JsonElement arg0, Type arg1, JsonDeserializationContext arg2) throws JsonParseException {
                JsonObject obj = arg0.getAsJsonObject();
